...
#[derive(Debug)]
pub struct ZenithBaseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZenithBaseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZenithBase processing");
    
    let mut processor = ZenithBaseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZenithBaseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZenithBaseProcessor::new(false);
